        ...
        <div id="content">
          <button type="button" id="sidebarCollapse" class="btn btn-info d-lg-none d-md-none">
           ...
           <form style="padding:4% !important" action="#" method="post" class="form-control bg-light text-dark" >
            <div class="row pl-3"><h3>My Items</i></h3></div>
            <hr class="bg-light">
            <div class=" " name="content" id="control2">
              <div class="row p-2 mt-2 border rounded bg-light text-dark">
                ...
                <div class="col-sm justify-content-md-center">
                  <center>
                     <div class="col p-1 ">
                        <button class="btn btn-outline-primary btnclass" >Edit <i class="fas fa-edit ml-1"></i></button>
                      </div>
                      <div class="col p-1">
                        <button onclick="return confirm('Are you sure?');" class="btn btn-outline-danger btnclass" onclick="" >Remove<i class="fas fa-trash ml-1"></i></button>
                      </div>
                  </center>
                </div>
              </div>
                ...
                <div class="col-sm justify-content-md-center">
                  <center>
                     <div class="col p-1 ">
                      ...
                      <div class="col p-1">
                        <button onclick="return confirm('Are you sure?');" class="btn btn-outline-danger btnclass">Remove<i class="fas fa-trash ml-1"></i></button>
                      </div>
                  </center>
                </div>
              </div>
