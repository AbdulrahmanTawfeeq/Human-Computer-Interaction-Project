...
<body class="bg-secondary" id="control1">
  <!-- Hole page container -->
    <div class="container-fluid login-container pt-3">
      <!-- Second header start -->
      <div class="bg-light pt-2 row">
        <div class="col col-lg-4 col-md-12 col-sm-12 form-inline">
           <input class="form-control col-8 d-inline" type="search" value="" id="searchinput" placeholder="Search">
          <span class="input-group-append">
            <button class="btn btn-primary  px-4" id="searchbutton" type="button">
        ...
        <div class="mt-4">
           <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
              <li class="breadcrumb-item p-2 rounded"><a href="index.php">Home</a></li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="wrapper">
        ...
        <div id="content">
          ...
          <form style="padding:4% !important" action="#" method="post" class="form-control bg-light text-dark" >
            <div class="row pl-3"><h3>Nearby Items </h3></div>
            <hr class="bg-light">
            <div class="" name="content" id="control2">
              <!-- item 1 -->
              <div class="row p-2 mt-2 border rounded bg-light text-dark" id="item1">
                ...
                <div class="col-sm justify-content-md-center">
                  <center>
                     <div class="col p-1 ">
                        <button class="btn btn-outline-primary btnclass">Request<i class="fas fa-cart-plus ml-1"></i></button>
                      </div>
                      <div class="col p-1">
                        <button class="btn btn-outline-warning text-dark btnclass" type="button" 
                        onclick="document.getElementById('item1').style.display = 'none';">Hide<i class="fas fa-eye-slash"></i></button>
                      </div>
                  </center>
                </div>
              </div>
